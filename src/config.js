...
// 模型列表
export const MODELS = [
  { id: "z-ai/glm-5.2:free", label: "glm-5.2-free", persona: 1 },
  { id: "minimax/minimax-m3:free", label: "minimax-m3", persona: 2 },
  { id: "nvidia/nemotron-3-ultra:free", label: "nemotron-ultra", persona: 3 },
];
